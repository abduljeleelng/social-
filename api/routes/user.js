...
const {userById,allUsers,getUser,updateUser, updateAbout,updateAboutA , deleteUser,addFollower,addFollowing,findPeople,removeFollower,removeFollowing,userPhoto} = require('../controllers/user');
...
//router.get('/auser/about/:userId', allUsers);
// photo
