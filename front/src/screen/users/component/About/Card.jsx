                ...
                <div className="main-menu-inner header-top-navigation">
                  <nav>
                    <ul className="main-menu">
                      <li><a href="#"><span>facebook</span> <i className="flaticon-facebook" /></a></li>
                      <li><a href="#"><span>twitter</span> <i className="flaticon-twitter-logo-silhouette" /></a></li>
                      <li><a href="#"><span>google</span> <i className="flaticon-google-plus" /></a></li>
                      <li><a href="#"><span>pinterest</span> <i className="flaticon-pinterest" /></a></li>
